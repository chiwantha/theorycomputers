      ...
      {path ? (
        <Link
          ...
          className={`flex items-center gap-4 ${
            posFullSidebar ? "px-4" : "px-3 justify-center"
        ...
        <button
          ...
          className={`w-full flex items-center ${
            posFullSidebar ? "px-4 justify-between" : "px-3 justify-center"
          } py-3 rounded-xl transition-all duration-200
          ${
            block
              ? "bg-red-300 text-white cursor-not-allowed"
            ...
            {sub.map((item, i) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-4 ${
                    posFullSidebar ? "px-4" : "px-2 justify-center"
