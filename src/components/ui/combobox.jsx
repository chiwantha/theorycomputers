  ...
  return (
    ...
    >
      ...
      <ChevronDownIcon
        ...
        className="pointer-events-none size-6 text-muted-foreground pr-2 text-gray-600"
      />
    </ComboboxPrimitive.Trigger>
  );
}
...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto outline-0 ring-0", className)}>
...
function ComboboxItem({ className, children, ...props }) {
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2  outline-hidden select-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
