...
function InputGroup({ className, ...props }) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input dark:bg-input/30 relative rounded-xl py-2 flex w-full items-center bg-gray-100 shadow-xs   transition-[color,box-shadow] outline-none",
        "min-w-0 ",
