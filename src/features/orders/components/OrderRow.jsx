...
const OrderRow = ({ item_list, warranty_list, defaultRows = false }) => {
  const rows = useORDERStore((state) => state.rows);
  const addRow = useORDERStore((state) => state.addRow);
  const updateRow = useORDERStore((state) => state.updateRow);
  const removeRow = useORDERStore((state) => state.removeRow);
  const setRows = useORDERStore((state) => state.setRows);
  const toggleSerials = useORDERStore((state) => state.toggleSerials);
  const updateSerial = useORDERStore((state) => state.updateSerial);
